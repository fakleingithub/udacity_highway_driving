      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for(int i = 0; i < sensor_fusion.size(); i++)
          {
            ...
            std::cout << "lanegoal: " << lanegoal << std::endl;
            ...
            if(d < (2+4*lane+2) && d > (2+4*lane-2))
            {
              ...
              if((check_car_s > car_s) && (check_car_s-car_s < 30))                  //if car is in front of us and gap is smaller than 30 meters
              {  
               //ref_vel = 29.5;
                too_close = true;       
                lane = lanegoal;
            ...
            if(d < (2+4*leftlane+2) && d > (2+4*leftlane-2))
            {
              ...
              // saves minimum distance to other vehicle in left lane (in front of ego vehicle)
              if( (check_car_s > car_s) && (freedistance_left > check_car_s-car_s) )          
              {  
            ...
            if(d < (2+4*rightlane+2) && d > (2+4*rightlane-2))
            {
              ...
              // saves minimum distance to other vehicle in right lane (in front of ego vehicle)
              if( (check_car_s > car_s) && (freedistance_right > check_car_s-car_s) )          
              {  
